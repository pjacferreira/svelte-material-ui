import { X as styleInject, _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, g as element, u as append_dev, s as safe_not_equal, ay as Icon, ax as Label, f as space, t as text, x as create_component, q as query_selector_all, h as detach_dev, j as claim_space, k as claim_element, l as children, m as claim_text, y as claim_component, p as add_location, o as attr_dev, r as insert_dev, z as mount_component, B as _slicedToArray, U as set_data_dev, C as transition_in, D as transition_out, E as destroy_component, w as validate_slots, L as binding_callbacks, M as bind, N as add_flush_callback } from './client.6af0488b.js';
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Fab> was created with unknown prop '".concat(key, "'"));
  });
...
var Fab_1 = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Fab_1, _SvelteComponentDev);

  var _super = _createSuper(Fab_1);
