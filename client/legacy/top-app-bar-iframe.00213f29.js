import { _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, g as element, u as append_dev, T as TopAppBar, s as safe_not_equal, R as Row, x as create_component, f as space, y as claim_component, j as claim_space, k as claim_element, l as children, h as detach_dev, p as add_location, z as mount_component, r as insert_dev, A as action_destroyer, B as _slicedToArray, C as transition_in, D as transition_out, E as destroy_component, w as validate_slots, F as stores$1, G as validate_store, H as component_subscribe, I as Section, J as Title, K as IconButton, L as binding_callbacks, M as bind, N as add_flush_callback, O as empty, P as group_outros, Q as check_outros, t as text, m as claim_text, U as set_data_dev } from './client.6af0488b.js';
import { L as LoremIpsum } from './LoremIpsum.1bc129fa.js';
...
function instance($$self, $$props, $$invalidate) {
  ...
  var _$$props$$$slots = $$props.$$slots,
      ...
      $$scope = $$props.$$scope;
  validate_slots("Top_app_bar_iframe", slots, []);
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Top_app_bar_iframe> was created with unknown prop '".concat(key, "'"));
  });
  ...
  $$self.$capture_state = function () {
    return {
      ...
      DenseFixedAdjust: DenseFixedAdjust,
      ProminentFixedAdjust: ProminentFixedAdjust,
      ShortFixedAdjust: ShortFixedAdjust,
  ...
  return [dense, prominent, variant, collapsed, title, Adjust, page, topappbar_collapsed_binding];
}

var Top_app_bar_iframe = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Top_app_bar_iframe, _SvelteComponentDev);

  var _super = _createSuper(Top_app_bar_iframe);
