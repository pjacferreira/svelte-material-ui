import { X as styleInject, _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, g as element, u as append_dev, aE as _toConsumableArray, V as validate_each_argument, s as safe_not_equal, t as text, k as claim_element, l as children, m as claim_text, h as detach_dev, o as attr_dev, p as add_location, r as insert_dev, v as noop, f as space, x as create_component, q as query_selector_all, j as claim_space, y as claim_component, aF as toggle_class, z as mount_component, B as _slicedToArray, C as transition_in, D as transition_out, W as destroy_each, E as destroy_component, w as validate_slots, L as binding_callbacks, M as bind, N as add_flush_callback } from './client.6af0488b.js';
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Elevation> was created with unknown prop '".concat(key, "'"));
  });
...
var Elevation = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Elevation, _SvelteComponentDev);

  var _super = _createSuper(Elevation);
