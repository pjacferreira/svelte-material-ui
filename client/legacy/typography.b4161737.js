...
function instance($$self, $$props) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Typography> was created with unknown prop '".concat(key, "'"));
  });
  return [];
}

var Typography = /*#__PURE__*/function (_SvelteComponentDev) {
